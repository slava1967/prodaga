          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-sm-7 col-md-7">
              <nav class="mainmenu text-center">
                <ul>
                  <li><nuxt-link exact to="/">Главная</nuxt-link></li>
                  <li class="menu-item-has-children">
                    <nuxt-link to="#">Категории</nuxt-link>
                    <ul class="sub-menu">
                      <li v-for="category in categories" :key="category.id"><nuxt-link :to="{ name: 'category-slug', params: { slug: category.slug }}">{{ category.name }}</nuxt-link></li>
                    </ul>
                  </li>
                  <li><nuxt-link to="#">Контакты</nuxt-link></li>
                  <li><nuxt-link to="#">Добавить</nuxt-link></li>
                </ul>
              </nav>
            </div>
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="dl-submenu">
                        <li v-for="category in categories" :key="category.id">
                          <nuxt-link :to="{ name: 'category-slug', params: { slug: category.slug }}">{{ category.name }}</nuxt-link></li>
                      </ul>
                    </li>
                    <li><nuxt-link to="#">Контакты</nuxt-link></li>
                    <li><nuxt-link to="#">Добавить</nuxt-link></li>
